...
import 'package:tdd_clean_atchitecture/features/number_trivia/data/repositories/number_trivia_repository_impl.dart';
...
void main() {
  ...
  group('getConcreateNumberTrivia', () {
    ...
    runTestOnline(() {
      ...
      test(
        'should cache the data locally when the call to repote data source is successful',
        () async {
          // arrange
          when(mockRemoteDataSource.getConcreteNumberTrivia(tNumber))
              .thenAnswer((_) async => tNumberTriviaModel);
  ...
  group('getRandomNumberTrivia', () {
    ...
    runTestOnline(() {
      ...
      test(
        'should return server vailer when the call to remote data source is unsuccessful',
        () async {
          // arrange
          when(mockRemoteDataSource.getRandomNumberTrivia())
              .thenThrow(ServerException());
