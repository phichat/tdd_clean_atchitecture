...
class SEdgeInsets extends EdgeInsets {
  ...
  const SEdgeInsets.hS1() : super.symmetric(horizontal: LayoutConstrains.s1);
  const SEdgeInsets.hS2() : super.symmetric(horizontal: LayoutConstrains.s2);
  const SEdgeInsets.hS3() : super.symmetric(horizontal: LayoutConstrains.s3);

  const SEdgeInsets.hM1() : super.symmetric(horizontal: LayoutConstrains.m1);
  const SEdgeInsets.hM2() : super.symmetric(horizontal: LayoutConstrains.m2);
  const SEdgeInsets.hM3() : super.symmetric(horizontal: LayoutConstrains.m3);

  const SEdgeInsets.hL1() : super.symmetric(horizontal: LayoutConstrains.l1);
  const SEdgeInsets.hL2() : super.symmetric(horizontal: LayoutConstrains.l2);
  const SEdgeInsets.hL3() : super.symmetric(horizontal: LayoutConstrains.l3);

  const SEdgeInsets.vS1() : super.symmetric(vertical: LayoutConstrains.s1);
  const SEdgeInsets.vS2() : super.symmetric(vertical: LayoutConstrains.s2);
  const SEdgeInsets.vS3() : super.symmetric(vertical: LayoutConstrains.s3);

  const SEdgeInsets.vM1() : super.symmetric(vertical: LayoutConstrains.m1);
  const SEdgeInsets.vM2() : super.symmetric(vertical: LayoutConstrains.m2);
  const SEdgeInsets.vM3() : super.symmetric(vertical: LayoutConstrains.m3);

  const SEdgeInsets.vL1() : super.symmetric(vertical: LayoutConstrains.l1);
  const SEdgeInsets.vL2() : super.symmetric(vertical: LayoutConstrains.l2);
  const SEdgeInsets.vL3() : super.symmetric(vertical: LayoutConstrains.l3);
  ...
  const SEdgeInsets.all10() : super.all(10);
