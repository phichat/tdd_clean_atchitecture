...
Future<T?> sshowSearch<T>({
  required BuildContext context,
  required SSearchDelegate<T> delegate,
  String? query = '',
...
/// ## Handling emojis and other complex characters
/// {@macro flutter.widgets.EditableText.onChanged}
abstract class SSearchDelegate<T> {
  ...
  // managed, owned, and set by the _SSearchPageRoute using this delegate.
...
class _SSearchPageRoute<T> extends PageRoute<T> {
  _SSearchPageRoute({
  ...
  final SSearchDelegate<T> delegate;
...
class _SSearchPage<T> extends StatefulWidget {
  const _SSearchPage({
    required this.delegate,
  ...
  @override
  State<StatefulWidget> createState() => _SSearchPageState<T>();
}

class _SSearchPageState<T> extends State<_SSearchPage<T>>
  ...
  @override
  void didUpdateWidget(_SSearchPage<T> oldWidget) {
        ...
        child: NotificationListener<ScrollNotification>(
          ...
          child: AnimatedBuilder(
              ...
              builder: (context, child) {
                final bottomHeight =
                    widget.delegate.buildBottom(context)?.preferredSize.height;
                return Scaffold(
                  appBar: PreferredSize(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        boxShadow: colorAnimationController.value == 1.0
                            ? SBoxShadow.appBar
                            : null,
                      ),
                      child: AppBar(
